...
public class CatzElevator {
    ...
    *---------------------------------------------------------------------------------------------*/
    ...
    public static double PID_ELEVATOR_UP_EMPTY_KP   = 1.25; // needs to be fixed to certain value
    public static double PID_ELEVATOR_UP_EMPTY_KI   = 0.00; // needs to be fixed to certain value
    public static double PID_ELEVATOR_UP_EMPTY_KD   = 0.00; // needs to be fixed to certain value

    public static double PID_ELEVATOR_DOWN_EMPTY_KP = 1.25; // needs to be fixed to certain value
    public static double PID_ELEVATOR_DOWN_EMPTY_KI = 0.00; // needs to be fixed to certain value
    public static double PID_ELEVATOR_DOWN_EMPTY_KD = 0.00; // needs to be fixed to certain value

    public static double PID_ELEVATOR_UP_CONE_KP    = 1.25; // needs to be fixed to certain value
    public static double PID_ELEVATOR_UP_CONE_KI    = 0.00; // needs to be fixed to certain value
    public static double PID_ELEVATOR_UP_CONE_KD    = 0.00; // needs to be fixed to certain value

    public static double PID_ELEVATOR_DOWN_CONE_KP  = 1.25; // needs to be fixed to certain value
    public static double PID_ELEVATOR_DOWN_CONE_KI  = 0.00; // needs to be fixed to certain value
    public static double PID_ELEVATOR_DOWN_CONE_KD  = 0.00; // needs to be fixed to certain value
