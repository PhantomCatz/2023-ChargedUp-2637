...
public class CatzIntake {
  ...
  private final double INTAKE_MAX_TORQUE = 5.84;
  ...
  private double time      = Timer.getFPGATimestamp();     //TBD - why this method? why are we saving this time? normally used with pivotTimer
